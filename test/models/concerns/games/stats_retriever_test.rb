...
class StatsRetrieverTest < ActiveSupport::TestCase
  ...
  should 'return a player as best player when tied for best' do
    game = create_game
  ...
  should 'return a player as worst player when tied for worst' do
    game = create_game
  ...
  should 'return null as worst player when all players are tied for stats' do
    game = create_game
